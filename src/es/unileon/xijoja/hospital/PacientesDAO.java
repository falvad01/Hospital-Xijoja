...
public class PacientesDAO {
     ...
     * @throws SQLException
     */
    public void addPatient(int id, String name, String surname1, String surname2, String NIE,Date date, int room,String disease, int idMedic, int idNurse) throws SQLException {
